...
│   CLARITY                              ACTION                   │
│   ───────                              ──────                   │
│   • Aggregate signals                  • Run platform programs  │
│   • Identify patterns                  • Create enablement      │
│   • Define cohorts                     • Escalate to PM         │
│   • Publish insights                   • Guide account teams    │
│                                                                 │
│                         ↓                                       │
│              REPEATABLE PLAYBOOKS                               │
│              Scale adoption across BU+1s                        │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
